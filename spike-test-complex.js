...
export function setup() {
    ...
    // Create the post
    const postTitle = 'THIS IS SPIKE TESTING POST';
    const postBody = 'This is the body of the SPIKE test post.';
    const postDescription = 'Description of the SPIKE test post';
    const postTags = ['test', 'SPIKE'];
...
export default function (data) {
    ...
    const comment = `SPIKE test comment ${commentNumber}`
